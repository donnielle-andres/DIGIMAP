...
def upload_file():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            newFile = cv2.imread(os.path.join(
            ...
            cv2.imwrite(os.path.join(
                app.config['UPLOAD_FOLDER'], equalized_filename), equal)
            return render_template('index.html', equalized_filename=equalized_filename, filename=filename)
